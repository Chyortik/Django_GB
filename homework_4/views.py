...
from homework_4.forms import ImageForm
from . import models
from . import forms


def index(request):
    return render(request, 'homework_4/base1.html')


def get_all_products(request):
    products = models.Product.objects.all()
    return render(request, 'homework_4/products.html', {'products': products})
...
def change_product(request, product_id):
    ...
    return render(request, 'homework_4/change_product.html', {'form': form})
...
def upload_image(request):
    if request.method == 'POST':
        ...
        form = ImageForm()
    return render(request, 'homework_4/upload_image.html', {'form': form})
