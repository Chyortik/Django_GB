...
def index(request):
    return render(request, "homework_3/index.html")
...
def basket(request, user_id):
    ...
    products.reverse()
    return render(request, 'homework_3/user_all_orders.html', {'user': user, 'orders': orders, 'products': products})
...
def sorted_basket(request, user_id, days_ago):
    ...
    return render(request, 'homework_3/user_all_product.html',
